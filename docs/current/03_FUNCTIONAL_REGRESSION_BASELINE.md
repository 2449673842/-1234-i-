...
> 代码范围：`deploy/prod-integration-v3`，Python WP3-WP10 与 R-WP0-WP3 基线；R-WP4 前六类集成候选已完成直接门禁，Step/Histogram/Freqpoly、Tile/Raster/Rect 与 Contour/ContourFilled 源分支能力已合入且当前批次复验待完成
