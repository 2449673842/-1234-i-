...
> 复核范围：生产 release `e35f4a4-jd22` 与隔离集成分支 `deploy/prod-integration-v3`，含 Python WP3 组件能力/Draft 收敛、WP4 无标签 collection 身份及 WP5 能力摘要浏览器验证；候选尚未部署
